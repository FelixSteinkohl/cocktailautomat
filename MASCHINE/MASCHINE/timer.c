...
unsigned short __attribute__ ((progmem)) const conTimerPrescaleFactor[] = {0,1,8,64,256,1024};
// the prescale division values stored in order of timer control register index
// STOP, CLK, CLK/8, CLK/32, CLK/64, CLK/128, CLK/256, CLK/1024
unsigned short __attribute__ ((progmem)) const TimerRTCPrescaleFactor[] = {0,1,8,32,64,128,256,1024};
